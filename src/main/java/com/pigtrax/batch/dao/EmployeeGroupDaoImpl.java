...
public class EmployeeGroupDaoImpl implements EmployeeGroupDao {
	...
	@Override
	public Integer getEmployeeGroupPKId(Integer companyId, String groupId)
			throws SQLException {
		StringBuffer qryBuffer = new StringBuffer();		
		qryBuffer.append("Select EG.\"id\" from pigtrax.\"EmployeeGroup\" EG join pigtrax.\"EmployeeJobFunction\" EJF on EG.\"id_EmployeeJobFunction\" = EJF.\"id\" "
